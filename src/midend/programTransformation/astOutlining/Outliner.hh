...
namespace Outliner
{
  ...
  ROSE_DLL_API extern bool useParameterWrapper;  // use an array of pointers wrapper for parameters of the outlined function
  ROSE_DLL_API extern bool useStructureWrapper;  // use a structure-type wrapper for parameters of the outlined function, this is a sub option for useParameterWrapper. false means using array, true means using structure
